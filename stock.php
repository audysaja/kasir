...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">Kassa Aplikasi</a>
            <!-- Sidebar Toggle-->
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-danger mb-4" data-bs-toggle="modal" data-bs-target="#edit<?=$idproduk;?>">
                                                    Delete
                                                </button> 
                                ...
                                <!-- modal delete -->
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" name="idp" values="<?=$idproduk;?>">
                                            </div>

                                            <!-- Modal footer -->
                                            <div class="modal-footer">
                                                <button type="submit" name="hapusbarang" class="btn btn-danger">Delete</button>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <!-- Modal footer -->
                                            <div class="modal-footer">
                                                <button type="submit" name="editbarang" class="btn btn-info">Submit</button>
                                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                                            </div>
...
<div class="modal fade" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal footer -->
      <div class="modal-footer">
        <button type="submit" name="tambahbarang" class="btn btn-info">Submit</button>
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
      </div>
